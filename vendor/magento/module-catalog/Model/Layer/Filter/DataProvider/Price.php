...
class Price
{
    ...
    public function validateFilter($filter)
    {
        ...
        foreach ($filter as $v) {
			...
			# 2) The line below is from Magento 2.4.0:
			# https://github.com/magento/magento2/blob/2.4.0/app/code/Magento/Catalog/Model/Layer/Filter/DataProvider/Price.php#L332
