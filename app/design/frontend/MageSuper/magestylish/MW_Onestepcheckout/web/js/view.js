...
window.OneStep.$(document).ready(function($){
    ...
    OneStep.Views.Shipping          = Backbone.View.extend({
        ...
        events: {
            ...
            "blur   #shipping\\:telephone"                  : "hdlBlurTelephone",
        ...
        hdlBlurTelephone: function (ev) {
            if (window.OneStep.$('#shipping\\:telephone').val()) {
                var params = {updateshippingaddress: true, updateshippingtype: (onestepConfig.ajaxShippingOnAddresss ? true : false)};
                view_onestep_init.update(params);
            }
        },
    ...
    OneStep.Views.Billing           = Backbone.View.extend({
        ...
        events: {
            ...
            "blur   #billing\\:telephone"               : "hdlBlurTelephone",
        ...
        hdlBlurTelephone: function (ev) {
            if (window.OneStep.$('#billing\\:telephone').val()) {
                var params = {
                    updateshippingtype: (onestepConfig.ajaxShippingOnAddresss ? true : false),
    ...
    OneStep.Views.Cart              = Backbone.View.extend({
        ...
        hdlUpdate: function(){
            var params = {updatecart: true, updateshippingtype: (onestepConfig.ajaxShippingOnQty ? true : false), updatepaymenttype: false};
            view_onestep_init.update(params);
        },
