...
define([
    ...
    return select.extend({
        ...
        onUpdate: function (value) {
            ...
            // form fields
            var fulfilledByField = uiRegistry.get('index = fulfilled_by_field');
            ...
            var fulfilledByFieldValue = fulfilledByField.value();

            if (value == 0) {
                this.showElement(fulfilledByField);
                ...
                if (fulfilledByFieldValue) {
                    this.obtainElementValue(fulfilledByFieldValue);
                }
            } else {
                this.hideElement(fulfilledByField);
                this.hideElement(fulfilledBySellerSelect);
                this.hideElement(fulfilledByAmazonSelect);
                this.hideElement(fulfilledBySellerText);
                this.hideElement(fulfilledByAmazonText);
