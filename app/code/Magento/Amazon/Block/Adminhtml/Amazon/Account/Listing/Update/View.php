...
namespace Magento\Amazon\Block\Adminhtml\Amazon\Account\Listing\Update;
...
class View extends Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_objectId = 'id';
        $this->_controller = 'adminhtml_amazon_account_listing_update';
        $this->_mode = 'view';
        $this->_blockGroup = 'Magento_Amazon';
        $this->setData('id', 'channel_amazon_account_listing_update');
    ...
    {
        return __('Amazon Listing Update');
    }
}
