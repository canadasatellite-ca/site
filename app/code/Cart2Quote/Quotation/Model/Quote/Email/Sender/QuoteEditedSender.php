...
/**
 * Class QuoteEditedSender
 * @package Cart2Quote\Quotation\Model\Quote\Email\Sender
 */
class QuoteEditedSender extends Sender
{
    use \Cart2Quote\Features\Traits\Model\Quote\Email\Sender\QuoteEditedSender {
    }

    /**
     * QuoteEditedSender constructor
     *
    ...
    public function __construct(
        ...
        $sendEmailIdentifier = \Cart2Quote\Quotation\Api\Data\QuoteInterface::SEND_QUOTE_EDITED_EMAIL,
        $emailSentIdentifier = \Cart2Quote\Quotation\Api\Data\QuoteInterface::QUOTE_EDITED_EMAIL_SENT
    ) {
        parent::__construct(
            $templateContainer,
            $identityContainer,
