 ...
 */
class QuoteReminderSender extends Sender
{
    use \Cart2Quote\Features\Traits\Model\Quote\Email\Sender\QuoteReminderSender {
    }

    /**
     * QuoteReminderSender constructor
     *
    ...
    public function __construct(
        ...
        $sendEmailIdentifier = \Cart2Quote\Quotation\Api\Data\QuoteInterface::SEND_REMINDER_EMAIL,
        $emailSentIdentifier = \Cart2Quote\Quotation\Api\Data\QuoteInterface::REMINDER_EMAIL_SENT
    ) {
        parent::__construct(
            $templateContainer,
            $identityContainer,
