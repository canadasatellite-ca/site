    ...
    AdminQuote.prototype = {
        ...
        applySubtotalProposal: function (amount, isPercentage) {
            if (isPercentage) {
                ...
                this.calculateSubtotalProposal(amount, isPercentage)
            }
        },

        calculatePercentage: function (discountPercentage) {
            if (discountPercentage > 0 && discountPercentage <= 100) {
                discountPercentage = 100 - discountPercentage;
                this.calculateSubtotalProposal(discountPercentage, true);
            } else {
                alert({
                    title: jQuery.mage.__('Discount Percentage invalid'),
                    content: jQuery.mage.__('Provide percentage of discount(for example: "50")'),
                })
            }
        },

        calculateSubtotalProposal: function (amount, isPercentage) {
