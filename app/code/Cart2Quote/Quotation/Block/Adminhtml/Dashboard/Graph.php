...
/**
 * Class Graph
 * Adminhtml dashboard image-charts block
 *
 * @package Cart2Quote\Quotation\Block\Adminhtml\Dashboard
 */
class Graph extends \Cart2Quote\Quotation\Block\Adminhtml\Dashboard\AbstractDashboard
{
    /**
     * Api URL
     */
    ...
    public function getChartUrl($directUrl = true)
    {
        ...
        //support for older versions of Magento (below v2.3.2)
        if (\Magento\Backend\Block\Dashboard\Graph::API_URL !== self::API_URL) {
            $directUrl = true;
        }
