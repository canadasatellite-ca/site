 ...
 */
class Starter extends \Cart2Quote\Quotation\Block\Adminhtml\System\Config\Form\Field\RequiredLicense
{
    /**
     * Starter constructor
    ...
    public function __construct(
        ...
        $template = 'Cart2Quote_Quotation::system/config/form/field/requiredLicense/starter.phtml',
        array $data = []
    ) {
    ...
    {
        return $this->license->isAllowedForEdition('starter');
    }
}
