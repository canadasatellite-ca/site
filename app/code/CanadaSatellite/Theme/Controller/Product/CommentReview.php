...
use Aheadworks\AdvancedReviews\Controller\Review\AbstractPostAction;

/**
 * Class CommentReview
 * @package CanadaSatellite\Theme\Controller\Product
 */
class CommentReview extends AbstractPostAction
{
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->getParam('success_v3')) {
            ...
            $data = [
                'success' => $success,
                'message' => __('We can\'t post your comment right now.'),
                'refresh' => false
            ];
        }
