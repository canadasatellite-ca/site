...
namespace CanadaSatellite\Theme\Model\ResourceModel\Card;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
	...
	{
		$this->_init('CanadaSatellite\Theme\Model\Card', 'CanadaSatellite\Theme\Model\ResourceModel\Card');
	}
	...
	public function loadWithFilter($printQuery = false, $logQuery = false)
	{
		...
		$data = $this->_restApi->getCardsByCustomerId($this->_magentoCustomerId);
		$this->resetData();
