...
/**
 * Test for \Aheadworks\AdvancedReviews\Ui\DataProvider\Review\Modifier\Frontend\ProductRecommended
 */
        ...
        return [
            ...
            [
                ...
                [
                    ReviewInterface::ID => 1,
                    ReviewInterface::PRODUCT_RECOMMENDED => ProductRecommendedSource::NO,
                    ReviewInterface::PRODUCT_RECOMMENDED . '_label' => __("I don't recommend<br /> this product"),
                ],
            ],
            [
                [
                ...
                [
                    ReviewInterface::ID => 1,
                    ReviewInterface::PRODUCT_RECOMMENDED => ProductRecommendedSource::YES,
                    ReviewInterface::PRODUCT_RECOMMENDED . '_label' => __("I recommend<br /> this product"),
                ],
            ],
        ];
    }
