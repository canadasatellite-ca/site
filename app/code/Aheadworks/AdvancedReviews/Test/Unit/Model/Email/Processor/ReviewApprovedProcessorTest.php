...
/**
 * Test for \Aheadworks\AdvancedReviews\Model\Email\Processor\ReviewApprovedProcessor
 */
class ReviewApprovedProcessorTest extends TestCase
{
    /**
     * @var ReviewApprovedProcessor
     */
    private $model;
    ...
    private $emailData = [
        ...
        EmailMetadataInterface::TEMPLATE_ID => ReviewApprovedProcessor::TEMPLATE,
    ...
    private function prepareMocks()
    {
        ...
        $this->reviewMock->expects($this->once())
            ->method('setData')
            ->with(ReviewApprovedProcessor::ABSOLUTE_RATING, $absoluteReviewRating);
