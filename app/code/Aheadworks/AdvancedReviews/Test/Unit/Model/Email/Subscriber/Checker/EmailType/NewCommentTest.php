...
use Aheadworks\AdvancedReviews\Model\Email\Subscriber\Checker\EmailType\NewComment;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use PHPUnit\Framework\TestCase;
use Aheadworks\AdvancedReviews\Api\Data\Email\SubscriberInterface;

/**
 * Test for \Aheadworks\AdvancedReviews\Model\Email\Subscriber\Checker\EmailType\NewComment
 */
class NewCommentTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->checker = $objectManager->getObject(NewComment::class, []);
    }
