...
namespace Aheadworks\AdvancedReviews\Block\Adminhtml\Page\Menu;

use Magento\Backend\Block\Template;
use Aheadworks\AdvancedReviews\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\AdvancedReviews\Block\Adminhtml\Page\Menu
 */
class Item extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_AdvancedReviews::page/menu/item.phtml';
