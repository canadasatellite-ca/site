...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
            ...
            if ($filepath!='' && file_exists($filepath)) {
                ...
                if (isset($data[0]) && !empty($data[0])) {
                        ...
                        if ($key!=0) {
                            ...
                            if (isset($categorieskey) && ($categorieskey!='' || $categorieskey===0)) {
                                ...
                                if ($cateitem->getId()) {
                                   ...
                                   /* $path = $cateitem->getPath();
                                    $urlKey = $cateitem->getUrlKey(); 
                                    $urlPath = $cateitem->getUrlPath();*/
                                    ...
                                    if ($parentid!=$_parentid && $cateitem->getId()>2) {
                                        ...
                                        if ($parentcat->getId()) {
                                            ...
                                            $resultRedirect->setPath('spontaneous_importcategory/*/edit');
                    ...
                    if (isset($alreadyexist) && !empty($alreadyexist)) {
                        ...
                        unlink($filepath);
                        $this->_backendSession->setSpontaneousImportcategoryTestData(false);
                        $resultRedirect->setPath('spontaneous_importcategory/*/edit');
                        return $resultRedirect;
                } else {
        ...
        $resultRedirect->setPath(
            'spontaneous_importcategory/*/edit',
            [
                '_current' => true
            ]
        );
