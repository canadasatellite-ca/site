...
class EwalletTopupNotification
{
    ...
    public function sendReminderEmail($subscription)
    {
        ...
        $itemData = $this->serialize->unserialize($subscription->getOrderItemInfo());
        $additionalData = $this->serialize->unserialize($subscription->getAdditionalInfo());
        ...
        $vars = [
            ...
            'sku' => isset($additionalData['product_sku']) ?: $product->getSku(),
            'qty' => isset($itemData['qty']) ?: 1,
