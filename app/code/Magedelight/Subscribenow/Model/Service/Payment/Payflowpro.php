...
class Payflowpro
{
    ...
    {
        if ($this->getMethodCode() == 'payflowpro') {
            ...
            return $publichash;
        } elseif ($this->getMethodCode() == 'payflowpro_cc_vault') {
