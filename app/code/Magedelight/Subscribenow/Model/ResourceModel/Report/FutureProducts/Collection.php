...
namespace Magedelight\Subscribenow\Model\ResourceModel\Report\FutureProducts;
...
class Collection extends \Magento\Sales\Model\ResourceModel\Report\Collection\AbstractCollection
{
    ...
    protected $tableForPeriod = [
        'daily'   => 'md_subscribenow_futureproducts_aggregated_daily',
        'monthly' => 'md_subscribenow_futureproducts_aggregated_monthly',
        'yearly'  => 'md_subscribenow_futureproducts_aggregated_yearly',
    ];
    ...
    protected function _makeBoundarySelect($from, $to)
    {
        ...
        $cols['subscription_count'] = 'SUM(subscription_count)';
    ...
    protected function _beforeLoad()
    {
        ...
        //echo '<pre>';print_r([$this->_from, $this->_to]);
        return $this;
    }
}