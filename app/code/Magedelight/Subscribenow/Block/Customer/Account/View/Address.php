...
class Address extends View
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $registry, $subscribeHelper, $timezone, $productRepository, $dataObject, $serialize, $data);
    ...
    {
        return (bool) $this->subscribeHelper->getScopeValue(
            SubscribeHelper::XML_PATH_ALLOWED_BILLING_EDIT,
            $storeId
        );
    }
    ...
    {
        return (bool) $this->subscribeHelper->getScopeValue(
            SubscribeHelper::XML_PATH_ALLOWED_SHIPPING_EDIT,
            $storeId
        );
    }
}
