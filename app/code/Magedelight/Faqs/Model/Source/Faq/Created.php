...
class Created implements \Magento\Framework\Data\OptionSourceInterface
{
    
    const ADMIN_CUSTOMER = 1;
    const LOGIN_CUSTOMER = 2;
    const GUEST_CUSTOMER = 3;
    ...
    {
        $options[] = ['label' => '', 'value' => ''];
        $availableOptions = $this->faq->getAvailableCreatedStatuses();
