...
namespace Magedelight\Firstdata\Observer;
...
class Mdfrd implements ObserverInterface
{
    ...
    public function __construct(
        ...
        \Magedelight\Firstdata\Helper\Mddata $helper,
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($_SERVER['SERVER_NAME'] != 'localhost' && $_SERVER['SERVER_ADDR'] != '127.0.0.1') {
            $keys['serial_key'] = $this->_scopeConfig->getValue('magedelight_firstdata/license/serial_key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
            $keys['activation_key'] = $this->_scopeConfig->getValue('magedelight_firstdata/license/activation_key', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
