...
use Auctane\Api\Model\Actions\Export;
use Auctane\Api\Model\Actions\ShipNotify;
...
class Index extends Action implements CsrfAwareActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            switch ($action) {
                case 'export':
                    $result = $this->export->process($request, $this->getResponse(), $this->storeManager->getStore()->getId());
                    break;
