 ...
 */
class CartSubmitFailure implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $reserved_order_id = $quote->getData('reserved_order_id');
        if ($reserved_order_id){
            $connection->query("UPDATE quote SET reserved_order_id='{$reserved_order_id}' WHERE entity_id='{$quote->getEntityId()}'");
        }
    }
}
