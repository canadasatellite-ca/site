    ...
    [
        ...
        $.validator.addMethod(
            ...
            function (value, element) {
                ...
                var fieldSetId = $(element).parents('.admin__page-section-item').attr('id');

                if ( typeof fieldSetId != "undefined" ){

                    var country, region, slectedRegion, postCodeChar, isValid = false;
                    country = $("#"+fieldSetId+"_country_id").val();
                    region = $("#"+fieldSetId+"_region_id").val();
                    ...
                    slectedRegion = $("#"+fieldSetId+"_region_id option:selected").text();
                ...
                console.warn('fieldSetId is undefined');
                return true;
