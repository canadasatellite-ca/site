...
class PcategoryQuestion extends \Magento\Framework\Model\AbstractModel
{

    const CATEGORY_ID = 'pcategory_id'; // We define the id fieldname
    ...
    {
        $this->_init('MageSuper\Faq\Model\ResourceModel\PcategoryQuestion');
    }
