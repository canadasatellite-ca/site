...
class Observer
{
	 ...
	 * "Prevent the Wyomind_SimpleGoogleShopping module from logging successful events to SimpleGoogleShopping-cron.log":
	 * https://github.com/canadasatellite-ca/site/issues/26
