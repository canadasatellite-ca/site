...
class Progress extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    public function startObservingProgress($logEnabled, $file="progress", $name="profile")
    {
     ...
     */
    public
    function log($message, $updateFlag=true, $status="PROCESSING", $percentage=0)
    {
