...
class SaleSummary extends AbstractModel
{
    ...
    public function getZReportSalesSummary($shiftId){
        ...
        foreach ($salesOrderCollection as $order){
            ...
            $giftcard += $this->_webposCurrencyHelper->currencyConvert($order->getGiftVoucherDiscount(),$orderCurrencyCode, $currentCurrencyCode);
            $points += $this->_webposCurrencyHelper->currencyConvert($order->getRewardpointsDiscount(),$orderCurrencyCode, $currentCurrencyCode);
        }
