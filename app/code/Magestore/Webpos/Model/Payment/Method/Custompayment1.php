...
/**
 * class \Magestore\Webpos\Model\Payment\Method\Custompayment1
 * 
 * Web POS Custom payment number one payment method model
 * Methods:
 *  assignData
 *  isAvailable
 * 
 ...
 */
class Custompayment1 extends \Magento\Payment\Model\Method\AbstractMethod
{
     ...
     * @var string
     */
    protected $_infoBlockType = 'Magestore\Webpos\Block\Payment\Method\Cc\Info\Cp1';
    ...
    public function isAvailable(\Magento\Quote\Api\Data\CartInterface $quote = null)
    {
        ...
        $settingEnabled = $this->_helperPayment->isCp1PaymentEnabled();
     ...
     * @param payment $data
     * @return \Magestore\Webpos\Model\Payment\Method\Custompayment1
     */
