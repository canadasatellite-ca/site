...
/**
 * class \Magestore\Webpos\Model\Payment\Method\Cod
 * 
...
class Cod extends \Magento\Payment\Model\Method\AbstractMethod
{
     ...
     * @var string
     */
    protected $_infoBlockType = 'Magestore\Webpos\Block\Payment\Method\Cc\Info\Cod';
    ...
    public function isAvailable(\Magento\Quote\Api\Data\CartInterface $quote = null)
    {
        ...
        $settingEnabled = $this->_helperPayment->isCodPaymentEnabled();
     ...
     * @param payment $data
     * @return \Magestore\Webpos\Model\Payment\Method\Cod
     */
