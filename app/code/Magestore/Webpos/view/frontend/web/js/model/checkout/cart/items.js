                ...
                if(quoteItems){
                    ...
                    $.each(quoteItems, function(index, itemData){
                        if(itemData.offline_item_id){
                            ...
                            var unitPrice = (itemData.base_original_price)?itemData.base_original_price:((Helper.isProductPriceIncludesTax())?itemData.base_price_incl_tax:itemData.base_price);
