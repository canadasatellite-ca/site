            ...
            collectTotals: function (orderData) {
                ...
                this.invoiceable = ko.pureComputed(function () {
                    if (self.orderData.call()) {
                        ...
                        var totalAmount = parseFloat(Helper.correctPrice(baseTotalPaid)) - parseFloat(baseTotalInvoiced) - parseFloat(baseTotalRefunded);
                        var totalAmount = Helper.correctPrice(totalAmount);
                        totalAmount = Helper.correctPrice(Helper.toBasePrice(totalAmount));
