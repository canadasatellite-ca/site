...
//        $this->priceFormatter = $priceFormatter;
    ...
    public function getPriceFormat($code)
    {
        ...
        if ($this->purchaseOrder->getCurrencyCode() !== 'CAD') {
            $this->cadCurrency = $this->currencyFactory->create()->load('CAD');
            $price = $this->getPrice($code);
            $priceCad = $price * $this->purchaseOrder->getCurrencyRate();

            return $this->cadCurrency->formatTxt($priceCad) . '; '.$this->currency->formatTxt($price);
        }
