...
class Index extends \Magento\Checkout\Controller\Index\Index
{
    ...
    function execute()
    {
        ...
        $this->_checkoutSession->setBeforeAuthUrl($currentUrl);
    ...
    function dispatch(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        $quote = $this->_objectManager->get('Cart2Quote\Quotation\Model\Session')->getQuote();
