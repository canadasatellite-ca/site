...
class TagActions extends \Magento\Ui\Component\Listing\Columns\Column
{
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'mageplaza_blog/tag/edit';
     ...
     * @var string
     */
    const URL_PATH_DELETE = 'mageplaza_blog/tag/delete';
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __('Are you sure you wan\'t to delete the Tag "${ $.$data.name }" ?')
                            ]
                        ]
                    ];
                }
